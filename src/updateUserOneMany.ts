...
import { METHOD_NOT_SUPPORT, FIND_CHECKR_ERROR, FIND_R_ERROR, UPDATE_ERROR, FIND_P_ERROR } from './constants/error'
import {IUpdateManyParams} from './types'



function fetchUpdateUserOneMany(params: IUpdateManyParams): Promise<any>{
...
export default fetchUpdateUserOneMany